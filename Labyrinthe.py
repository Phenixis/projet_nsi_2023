...
def draw_lab(surface, g, region):
    ...
    pygame.draw.line(surface, WALL_COLOR, (0, 0), (COLUMNS * 50, 0), 4)  # ligne du haut
    pygame.draw.line(surface, WALL_COLOR, (COLUMNS * 50, 0), (COLUMNS * 50, ROWS * 50), 4)  # ligne de droite
    pygame.draw.line(surface, WALL_COLOR, (COLUMNS * 50, ROWS * 50), (0, ROWS * 50), 4)  # ligne du bas
    pygame.draw.line(surface, WALL_COLOR, (0, ROWS * 50), (0, 0), 4)  # ligne de gauche
...
def main(surface, level):
    ...
    for case in dfs_path(graphe, (0, 0), (23, 15)):
        region[case][2] = 1
